...
export class AnimalService {
  ...
  //Metodo FichaMedica
  // public getFichaMedById(id_fichamedica: number) {
  //   return this.http.get<any>(API_URI + '/ficha/buscarfichaMedica/' +id_fichamedica);
  // }
  ...
  //Metodo fichas med
  // public saveCrearFichas(ficha:any){
  //   return this.http.post(API_URI+'/ficha/crearfichaMedica',ficha);
  // }
  ...
  //Find all
  public findAllAnimalsIdAndNombreLike(nombre: any) {
    return this.http.get<any>(API_URI + '/animal/findAll/filter/' + nombre);
  }
  ...
  //Filtro para usuario de sus animales de preferencia..
  public findByGenderAnimal(id_raza: any, gender: any) {
    return this.http.get<any>(API_URI + '/animal/filter/raza/findByGenderAnimal/'+id_raza+'/'+gender);
  }
  ...
  //Obtener todos los animales referente a su letra.
  public findByEstadoAndRaAnimal_RazaAnimal_NombretipoStartingWithIgnoreCase(letter: any) {
    return this.http.get<any>(API_URI + '/animal/getalltipos/filterbyletter/tipo/'+letter);
  }
